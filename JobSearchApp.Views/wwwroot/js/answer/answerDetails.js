// URL de la API
const apiUrl = 'https://localhost:7056/api/answer';
...
document.addEventListener('DOMContentLoaded', fetchAnswerDetails); // Asegurarse de que la función se llame al cargar el DOM
